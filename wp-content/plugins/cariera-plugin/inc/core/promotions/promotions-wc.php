...
* 
* ========================
* CARIERA CORE - PROMOTIONS WOOCOMMERCE
* ========================
*     
**/
...
class Cariera_Core_Promotions_WC {
	...
	public $package;     // Instance of Cariera_Core_Promotion_Package.
	public $promotions;  // Instance of Cariera_Core_Promotions.
	...
	public function get_job_promotions_modal() {
		...
		<div id="promotions-modal" class="small-dialog zoom-anim-dialog mfp-hide">
			<div class="small-dialog-headline">
				<h3 class="title"><?php esc_html_e( 'Job Promotion', 'cariera' ); ?></h3>
			</div>
					...
					if ( ! empty( $products ) ) { ?>
						...
						<ul class="promo-packages buy-packages">
							<?php foreach( (array) $products as $product ) {
								if ( ! $product->is_type( 'job_promotion_package' ) || ! $product->is_purchasable() || $product->get_duration() <= 0 ) {
									continue;
								} ?>
									...
									<a href="#">
										...
										<div class="package-details">
											...
											<?php if ( !empty($product->get_short_description()) ) { ?>
												<p class="promo-desc"><?php echo esc_html( $product->get_short_description() ); ?></p>
											<?php } ?>
											<p>
	...
	public function get_company_promotions_modal() {
		...
		<div id="promotions-modal" class="small-dialog zoom-anim-dialog mfp-hide">
			<div class="small-dialog-headline">
				<h3 class="title"><?php esc_html_e( 'Company Promotion', 'cariera' ); ?></h3>
			</div>
			...
			<div class="small-dialog-content">
				<div class="promo-packages-wrapper">
					...
					if ( ! empty( $products ) ) { ?>
						...
						<ul class="promo-packages buy-packages">
							<?php foreach( (array) $products as $product ) {
								if ( ! $product->is_type( 'company_promotion_package' ) || ! $product->is_purchasable() || $product->get_duration() <= 0 ) {
									continue;
								} ?>
	...
	public function get_resume_promotions_modal() {
		...
		<div id="promotions-modal" class="small-dialog zoom-anim-dialog mfp-hide">
			<div class="small-dialog-headline">
				<h3 class="title"><?php esc_html_e( 'Resume Promotion', 'cariera' ); ?></h3>
			</div>
			...
			<div class="small-dialog-content">
				<div class="promo-packages-wrapper">
					...
					if ( ! empty( $products ) ) { ?>
						...
						<ul class="promo-packages buy-packages">
							<?php foreach( (array) $products as $product ) {
								if ( ! $product->is_type( 'resume_promotion_package' ) || ! $product->is_purchasable() || $product->get_duration() <= 0 ) {
									continue;
								} ?>
