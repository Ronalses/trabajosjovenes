...
class Cariera_Core_Promotions {
    ...
    public $woocommerce;     // Instance of Cariera_Core_Promotions.
	...
	public function include_files( $types ) {
        include_once( CARIERA_PATH . '/inc/core/promotions/package.php' );
        include_once( CARIERA_PATH . '/inc/core/promotions/promotions-wc.php' );
		include_once( CARIERA_PATH . '/inc/core/promotions/wc-product-listing-promotion.php' );
    }
	...
	public function expire_package( $package_id ) {
		...
		if ( $listing_id ) {
			...
			$wpdb->update( $wpdb->posts, [ 'menu_order' => 0 ], [ 'ID' => $listing_id, 'menu_order' => -1 ] );
