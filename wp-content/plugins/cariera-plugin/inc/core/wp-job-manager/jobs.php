...
new Cariera_Job_Extender();



function cariera_job_deregister() {
    ...
    if ( defined( 'JOB_MANAGER_VERSION' ) ) {
        ...
        wp_register_script( 'wp-job-manager-ajax-filters', CARIERA_URL . '/assets/dist/js/jobs-ajax-filters.js', $ajax_filter_deps, '1.3.0', true );
        wp_localize_script( 'wp-job-manager-ajax-filters', 'job_manager_ajax_filters', $ajax_data );
    }
}

add_action( 'wp_print_scripts', 'cariera_job_deregister', 100 );