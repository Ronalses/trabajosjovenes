...
class Cariera_Blog_Posts extends Widget_Base {
    ...
    */
    public function get_title() {
        return esc_html__( 'Blog Posts', 'cariera' );
    }
    ...
    */
    protected function _register_controls() {
        ...
        $this->add_control(
            'columns_grid',
            [
                'label'         => esc_html__( 'Columns Grid', 'cariera' ),
                'type'          => Controls_Manager::SELECT,
                'options'       => [
                    '6'         => esc_html__( 'Two Columns', 'cariera' ),
                    '4'         => esc_html__( 'Three Columns', 'cariera' ),
                    '3'         => esc_html__( 'Four Columns', 'cariera' ),
                ],
                'default'       => '4',                
            ]
        );
        ...
        $this->add_control(
            'button',
            [
                'label'         => esc_html__( 'Button Name', 'cariera' ),
                'type'          => Controls_Manager::TEXT,
                'default'       => 'Read More',
                'label_block'   => true,
                'description'   => esc_html__( 'Delete the text of the field if you want to hide the "read more" button', 'cariera' ),
            ]
        );
        $this->add_control(
            'read_more_link',
            [
                'label'         => esc_html__( 'Read All URL', 'cariera' ),
    ...
    */
    protected function render() {
        ...
        <div class="blog-posts-wrapper row">
            ...
            if( $posts_query->have_posts() ) {
                ...
                if ( $settings['post_layout'] == 'layout1' ) { ?>
                    ...
                    <div class="col-md-<?php echo $settings['columns_grid']; ?>" id="post-<?php the_ID(); ?>">
                        <div class="blog-post-layout shadow-hover">
                            ...
                            if ( $settings['show_thumb'] == 'show' ) {
                                ...
                                <a href="<?php echo get_permalink(); ?>" class="bloglist-thumb-link hover-link">
                            ...
                            <div class="bloglist-text-wrapper">
                                ...
                                <div class="bloglist-excerpt">
                                    ...
                                    <a href="<?php echo get_permalink(); ?>" class="btn btn-main btn-effect"><?php esc_html_e( 'read more', 'cariera' ); ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-<?php echo $settings['columns_grid']; ?>" id="post-<?php the_ID(); ?>">
                        <div class="blog-post-layout2">
                            ...
                            <div class="bloglist-text-wrapper">
                                ...
                                <span class="post-category"><a href="<?php echo esc_url(get_category_link(get_cat_id( $post_cat[0]->name ))); ?>"><?php echo $post_cat[0]->name; ?></a></span>
                                <h4 class="bloglist-title">
                                    <a href="<?php echo esc_url( get_permalink() ); ?>" title="<?php echo esc_attr(get_the_title()); ?>"><?php echo esc_html( get_the_title() ); ?></a>
                                </h4>
                        ...
                        <a href="<?php the_permalink(); ?>" class="blog-post-layout3">
                            <div class="blog-grid-item">
                                ...
                                if( $settings['show_cats'] == 'yes' ) {
                                    if( has_category() ) { ?>
                                        <span class="item-cat">
                                            <?php $post_cat = get_the_category(); echo esc_html($post_cat[0]->name ) ?>
                                        </span>
                                    <?php }
                                } ?>
        ...
        // Read all link
        if( $button != '' ) {
           echo '<div class="text-center mt20"><a href="' . $url . '" ' . $target . ' class="btn btn-main btn-effect" ' . $follow . '>' . $button . '</a></div>';
        }
