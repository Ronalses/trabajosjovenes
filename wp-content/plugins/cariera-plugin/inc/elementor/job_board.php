...
class Cariera_Job_Board extends Widget_Base {
    ...
    */
    protected function render( ) {
        ...
        $job_attr = [ $layout, $layout_ver, $per_page, $orderby, $order, $show_filters, $pagination, $featured, $filled, $keyword, $location, $categories, $job_types ];
