    ...
    <main class="login-register-page">
        <div class="container-fluid">
            <div class="row align-items-center">
                ...
                <!-- Form Wrapper -->
                <div class="col-xl-4 col-lg-6 col-md-6 form-wrapper">
                    <div class="content">
                        ...
                        <div class="signin-wrapper">
                            ...
                            <div class="bottom-links">
                                <a href="#" class="signUpClick"><i class="fas fa-user"></i><?php esc_html_e( 'Don\'t have an account?', 'cariera' ); ?></a>
                                <a href="#" class="forgetPasswordClick"><i class="fas fa-lock"></i><?php esc_html_e( 'Forgot Password?', 'cariera' ); ?></a>
                            </div>
                        ...
                        <div class="signup-wrapper">
                            ...
                            <div class="bottom-links">
                                <a href="#" class="signInClick"><i class="fas fa-user"></i><?php esc_html_e( 'Already registered?', 'cariera' ); ?></a>
                                <a href="#" class="forgetPasswordClick"><i class="fas fa-lock"></i><?php esc_html_e( 'Forgot Password?', 'cariera' ); ?></a>
                            </div>
                        ...
                        <div class="forgetpassword-wrapper">
                            ...
                            <div class="bottom-links">
                                <a href="#" class="cancelClick"><i class="fas fa-arrow-left"></i><?php esc_html_e( 'Sign in', 'cariera' ); ?></a>
                            </div>
...
// else user is logged
    ...
    <main class="login-register-page ptb80">
        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
            <div class="container">
                ...
                <div class="myaccount-loggedin">                        
                    ...
                    <h3 class="mb30"><?php printf( esc_html__( 'Hello %1$s', 'cariera' ), '<span class="text-primary">' . $current_user->display_name . '</span>' ); ?></h3>
                    <a class="btn btn-main btn-effect mr10 mb10" href="<?php echo esc_url($account_link); ?>"><?php esc_html_e( 'Dashboard', 'cariera' ); ?></a>
                    <a class="btn btn-main btn-effect mr10 mb10" href="<?php echo wp_logout_url('index.php');  ?>"><?php esc_html_e('Log out','cariera') ?></a>                        
                </div>
