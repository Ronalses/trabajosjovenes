...
<form method="post" id="job_preview" action="<?php echo esc_url( $form->get_action() ); ?>">
	...
	<div class="job_listing_preview_title">
		...
		<input type="submit" name="continue" id="job_preview_submit_button" class="button job-manager-button-submit-listing" value="<?php echo apply_filters( 'submit_job_step_preview_submit_text', esc_html__( 'Submit Listing &rarr;', 'cariera' ) ); ?>" />		
		<h2><?php esc_html_e( 'Preview', 'cariera' ); ?></h2>
	</div>
