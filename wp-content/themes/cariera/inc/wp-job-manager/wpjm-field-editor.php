...
* 
* ========================
* WP JOB MANAGER - FIELD EDITOR COMPATIBILITY FUNCTIONS
* ========================
*     
**/
...
/**
 * Custom autoput areas for the WPJM Field Editor Plugin
 *
 * @since  1.4.6
 */
function cariera_wpjm_field_editor_auto_output( $output_options, $list_field_group ) {
...
add_filter( 'field_editor_output_options', 'cariera_wpjm_field_editor_auto_output', 10, 2 );