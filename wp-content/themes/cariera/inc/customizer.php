...
function cariera_customize_settings() {
	...
	return array(
        ...
        'sections' => array(
            ...
            'half_map_company_options'  => array(
        ...
        'fields'   => array(
            ...
            'cariera_top_header_style' => array(
                'type'        => 'select',
            ...
            'cariera_fullwidth_header' => array(
                'type'        => 'switch',
            ...
            'cariera_body_bg_horizontal'           => array(
				'type'            => 'select',
			...
			'cariera_body_bg_vertical'             => array(
				'type'            => 'select',
			...
			'cariera_body_bg_attachments'          => array(
				'type'            => 'select',
            ...
            'cariera_preloader_version' => array(
                'type'        => 'select',
            ...
            'cariera_menu_hover_color' => array(
                'type'        => 'color',
            ...
            'cariera_job_category_custom'   => array(
				'type'     => 'custom',
				'section'  => 'job_options',
				'default'  => '<hr>',
				'priority' => 10,
            ...
            // JOB TAXONOMY OPTIONS
            'cariera_job_taxonomy_layout' => array(
                'type'        => 'select',
            ...
            'cariera_job_taxonomy_list_version' => array(
                'type'        => 'select',
            ...
            'cariera_job_taxonomy_grid_version' => array(
                'type'        => 'select',
            ...
            // HALF MAP JOB OPTIONS
            'cariera_job_half_map_text' => array(
                'type'        => 'text',
            ...
            'cariera_job_half_map_layout' => array(
                'type'        => 'select',
            ...
            'cariera_half_map_single_job_layout' => array(
                'type'        => 'select',
                'label'       => esc_html__( 'Single Job Layout', 'cariera' ),
            ...
            // SINGLE JOB OPTIONS
            'cariera_single_job_layout' => array(
                'type'        => 'select',
                'label'       => esc_html__( 'Job Page Layout', 'cariera' ),
                'description' => esc_html__( 'Choose the sidebar side for your job page.', 'cariera' ),
            ...
            //  GENERAL JOB OPTIONS
            'cariera_company_search_map' => array(
                'type'        => 'switch',
            ...
            // HALF MAP JOB OPTIONS
            'cariera_company_half_map_text' => array(
                'type'        => 'text',
                'label'       => esc_html__( 'Half Map Text', 'cariera' ),
                'description' => esc_html__( 'Add the text that will show up on top of the search.', 'cariera' ),
            ...
            'cariera_company_half_map_layout' => array(
                'type'        => 'select',
                'label'       => esc_html__( 'Half Map Layout', 'cariera' ),
            ...
            // RESUME OPTIONS
            'cariera_resume_search_map'        => array(
				'type'            => 'switch',
            ...
            // JOB TAXONOMY OPTIONS
            'cariera_resume_taxonomy_layout' => array(
                'type'        => 'select',
            ...
            'cariera_resume_taxonomy_list_version' => array(
                'type'        => 'select',
            ...
            'cariera_resume_taxonomy_grid_version' => array(
                'type'        => 'select',
            ...
            // HALF MAP RESUME OPTIONS
            'cariera_resume_half_map_text' => array(
                'type'        => 'text',
                'label'       => esc_html__( 'Half Map Text', 'cariera' ),
                'description' => esc_html__( 'Add the text that will show up on top of the search.', 'cariera' ),
            ...
            'cariera_resume_half_map_layout' => array(
                'type'        => 'select',
                'label'       => esc_html__( 'Half Map Layout', 'cariera' ),
            ...
            // PAGE HEADER BLOG OPTIONS
            'cariera_blog_page_header' => array(
                'type'        => 'switch',
            ...
            'cariera_related_products' => array(
                'type'            => 'switch',
            ...
            'cariera_footer_title_color'  => array(
                'type'        => 'color',
            ...
            'cariera_footer_sidebar_1' => array(
                'type'          => 'select',
            ...
            'cariera_footer_sidebar_2' => array(
                'type'          => 'select',
            ...
            'cariera_footer_sidebar_3' => array(
                'type'          => 'select',
            ...
            'cariera_footer_sidebar_4' => array(
                'type'          => 'select',
            ...
            // DASHBOARD OPTIONS
            'cariera_dashboard_page_enable'     => array(
                'type'        => 'switch',
            ...
            'cariera_dashboard_job_alerts_page_enable'     => array(
                'type'        => 'switch',
            ...
            'cariera_dashboard_bookmark_page_enable'     => array(
                'type'        => 'switch',
            ...
            'cariera_dashboard_applied_jobs_page_enable'     => array(
                'type'        => 'switch',
            ...
            'cariera_dashboard_listing_reports_page_enable'     => array(
                'type'        => 'switch',
            ...
            'cariera_dashboard_orders_page_enable'     => array(
                'type'        => 'switch',
            ...
            'cariera_dashboard_profile_page_enable'     => array(
                'type'        => 'switch',
            ...
            'cariera_dashboard_custom6'            => array(
				'type'     => 'custom',
				'section'  => 'dashboard',
				'default'  => '<hr>',
				'priority' => 10,
            ...
            'cariera_dashboard_views_statistics'    => array(
                'type'          => 'switch',
            ...
            'cariera_dashboard_statistics_border'    => array(
                'type'          => 'color',
            ...
            'cariera_dashboard_statistics_background'    => array(
                'type'          => 'color',
            ...
            'cariera_mapbox_access_token'                => array(
				'type'          => 'text',
            ...
            'cariera_job_location_autocomplete'     => array(
                'type'        => 'switch',
            ...
            'cariera_map_restriction' => array(
                'type'        => 'text',
                'label'       => esc_html__( 'Restrict Search Result', 'cariera' ),
                'description' => esc_html__( 'Add your Country code to restrict the search results to that country. For example: de for Germany.', 'cariera' ),
                'section'     => 'map_options',
                'priority'    => 10,
                'active_callback'  => array(
                    array(
            ...
            'cariera_job_auto_location' => array(
                'type'        => 'switch',
            ...
            'cariera_max_radius_search_value' => array(
                'type'        => 'text',
...
if ( class_exists( 'Kirki' ) ) {
	add_action( 'init', 'cariera_customize_init', 30 );
} else {
	$cariera_customize = new Cariera_Customize( cariera_customize_settings() );
}